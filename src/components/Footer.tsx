        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-background/60 mb-6 max-w-xs">
              Premium skincare crafted with care. For radiant, healthy skin every day.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-body font-semibold text-background mb-4">Shop</h4>
            <ul className="space-y-3">
              <li><a href="#" className="text-sm hover:text-primary transition-colors">All Products</a></li>
              <li><a href="#" className="text-sm hover:text-primary transition-colors">Cleansers</a></li>
              <li><a href="#" className="text-sm hover:text-primary transition-colors">Serums</a></li>
              <li><a href="#" className="text-sm hover:text-primary transition-colors">Moisturizers</a></li>
              <li><a href="#" className="text-sm hover:text-primary transition-colors">Sets & Bundles</a></li>
            </ul>
          </div>

          {/* Support */}
          <div>
            <h4 className="font-body font-semibold text-background mb-4">Support</h4>
            <ul className="space-y-3">
              <li><a href="#" className="text-sm hover:text-primary transition-colors">Contact Us</a></li>
              <li><a href="#" className="text-sm hover:text-primary transition-colors">Shipping Info</a></li>
              <li><a href="#" className="text-sm hover:text-primary transition-colors">Returns & Exchanges</a></li>
          ...
          {/* Newsletter */}
          <div>
            <h4 className="font-body font-semibold text-background mb-4">Stay Updated</h4>
